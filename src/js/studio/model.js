...
export const CHART_PICKER = [
  ...
  { kind: "barpct", label: "Column (100%)", icon: "▦" },
  { kind: "areapct", label: "Area (100%)", icon: "◫" },
];
...
export function chartDefaults(kind) {
  ...
  switch (kind) {
    ...
    case "barpct": // 100% stacked column — every category normalised to 100
      return { props: { kind: "bar", stacked: true, percent: true, xLabels: cats, axisMax: 0, series: three([4.3, 2.5, 3.5, 4.5], [2.4, 4.4, 1.8, 2.8], [2, 2, 3, 5]) } };
    case "areapct": // 100% stacked area
      return { props: { kind: "area", stacked: true, percent: true, xLabels: ["2025", "2027", "2029", "2031", "2033", "2035"], axisMax: 0,
        series: [
