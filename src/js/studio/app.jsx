...
const PANELW_KEY = "studio.panelw";
...
.st-split:hover::after,.st-split:active::after{background:rgba(108,92,231,0.5);}
...
.st-imgtab{background:none;border:1px solid transparent;border-radius:8px;color:rgba(233,236,255,0.75);padding:6px 12px;font:inherit;font-size:13px;cursor:pointer;}
.st-imgtab:hover{background:rgba(233,236,255,0.07);color:#fff;}
.st-imgtab.on{background:rgba(108,92,231,0.22);border-color:rgba(108,92,231,0.5);color:#fff;}
.st-dropzone{display:flex;flex-direction:column;align-items:center;gap:6px;border:1.5px dashed rgba(233,236,255,0.3);border-radius:12px;padding:34px 16px;cursor:pointer;text-align:center;transition:border-color .15s,background .15s;}
.st-dropzone:hover{border-color:rgba(108,92,231,0.7);background:rgba(108,92,231,0.08);}
.st-dropzone-icon{font-size:34px;}
.st-dropzone span{color:rgba(233,236,255,0.55);font-size:12.5px;}
.st-imgrow{display:flex;gap:8px;align-items:center;}
.st-imginput,.st-imgprompt,.st-imgselect{flex:1;background:rgba(12,17,36,0.6);border:1px solid var(--line);border-radius:8px;color:inherit;font:inherit;font-size:13.5px;padding:8px 10px;}
...
.st-ovitem{position:relative;border:1px solid var(--line);border-radius:8px;overflow:hidden;padding:0;background:rgba(12,17,36,0.5);cursor:pointer;aspect-ratio:4/3;}
.st-ovitem img{width:100%;height:100%;object-fit:cover;display:block;}
.st-ovitem span{position:absolute;left:4px;bottom:4px;background:rgba(6,9,18,0.75);border-radius:4px;padding:1px 5px;font-size:9.5px;letter-spacing:.5px;color:rgba(233,236,255,0.85);}
.st-ovitem:hover{border-color:rgba(108,92,231,0.8);}
.st-genprev{width:100%;max-height:320px;object-fit:contain;border-radius:10px;border:1px solid var(--line);background:rgba(12,17,36,0.5);}
